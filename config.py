...
class Config(object):
    def __init__(self):
        ...
        if DB == '10x':
            ...
            self.rna_paths = ['sce_10xPBMC_rna_skip_referenced_random_new_corrected.npy']
            self.rna_labels = ['data/maize_leaf_harmony_integrated.v3.subLEIDEN.metadata.txt']		
            self.atac_paths = ['sce_10xPBMC_atac_skip_referenced_random_new_corrected.npy']
            ...
            self.seed = 1
            self.checkpoint = 'model/checkpoint.pth.tar'
